...
func ListTemplates(c *gin.Context) {
	...
	c.HTML(200, "template.html", gin.H{"csrf": csrf.GetToken(c), "tempBannerValue": tempBannerValue, "linktitle": "Templates", "Menu": menu, "translate": translate, "SettingsHead": true, "title": "Next.js Templates", "TemplateModules": finalList, "Count": mainCount, "IsCountZero": allZeros, "Filter": keyword, "Previous": previous, "Next": next, "PageCount": pageCount, "CurrentPage": pageno, "Page": page, "Limit": limit, "Paginationendcount": paginationendcount, "ChannelList": finalChannelList, "ChannelDetail": channelDetails, "templatelist": goTemplateList, "Paginationstartcount": paginationstartcount, "Pagination": PaginationData{
		NextPage:     pageno + 1,
