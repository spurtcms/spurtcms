...
func Personalization(c *gin.Context) {
	...
	models.GetPersonalize(&personalize_data, id)
	...
	c.HTML(200, "personalize.html", gin.H{"Menu": menu, "title": "Personalize", "csrf": csrf.GetToken(c), "HeadTitle": translate.Setting.Personalize, "translate": translate, "Folder": Folder, "File": File, "Media": Media, "logo": logo, "SettingsHead": true, "Personalizemenu": true, "Tooltiptitle": translate.Setting.Personalizetooltip, "StorageType": selectedtype.SelectedType})
}
...
func PersonalizationUpdate(c *gin.Context) {
	...
	err := models.GetPersonalize(&personalize_data, id)
	if err != nil {
		...
		err2 := models.UpdatePersonalize(&personalize_data, id)
		if err2 != nil {
