...
type TblChannelEntries struct {
	...
	AccessType         string    `gorm:"type:varchar(255);DEFAULT:'every_one'"`
	UserRoleId         int       `gorm:"type:int"`
	MembershipLevelId  int       `gorm:"type:int"`
}
...
type TblMembershipMembers struct {
	...
	LastLogin        int        `gorm:"type:int"`
	Password         string     `gorm:"type:varchar(255)"`
	Username         *string    `gorm:"type:varchar(255);default:null"` // nullable
...
type TblMstrMembershiplevel struct {
	...
	Description            string     `gorm:"type:varchar(255)"`
	MembershiplevelDetails string     `gorm:"type:varchar(255)"`
	MembergroupLevelId     int        `gorm:"type:int"`
	InitialPayment         float64    `gorm:"type:decimal(10,2)"`
	IsDiscount             int        `gorm:"type:int"`
	DiscountPercentage     int        `gorm:"type:int"`
...
type TblMembershipSubcriptions struct {
	Id                        int        `gorm:"primaryKey;autoIncrement"`
	MemberId                  int        `gorm:"type:int"`
	Gateway                   string     `gorm:"type:varchar(255)"`
	GatewayEnvironment        string     `gorm:"type:varchar(255)"`
	SubscriptionTransactionId string     `gorm:"type:varchar(255)"`
	IsDeleted                 int        `gorm:"type:int"`
	DeletedOn                 *time.Time `gorm:"type:datetime;default:null"`
	DeletedBy                 *int       `gorm:"default:null"`
	CreatedOn                 *time.Time `gorm:"type:datetime;default:null"`
	...
	TenantId                  string     `gorm:"type:varchar(255)"`
	MembershipLevelId         int        `gorm:"type:int"`
	MemberName                string     `gorm:"type:varchar(255)"`
	IsActive                  int        `gorm:"type:int"`
}
...
type TblMembershipOrder struct {
	...
	UserId                    int        `gorm:"type:int"`
	MembershiplevelId         int        `gorm:"type:int"`
	BillingName               string     `gorm:"type:varchar(255)"`
	BillingStreet             string     `gorm:"type:varchar(255)"`
	BillingStreet2            string     `gorm:"type:varchar(255)"`
	BillingCity               string     `gorm:"type:varchar(255)"`
	BillingState              string     `gorm:"type:varchar(255)"`
	BillingPostalcode         string     `gorm:"type:varchar(255)"`
	BillingCountry            string     `gorm:"type:varchar(255)"`
	BillingPhone              string     `gorm:"type:varchar(255)"`
	SubTotal                  int        `gorm:"type:int"`
	Tax                       int        `gorm:"type:int"`
	Total                     string     `gorm:"type:varchar(255)"`
	PaymentType               string     `gorm:"type:varchar(255)"`
	Status                    string     `gorm:"type:varchar(255)"`
	Gateway                   string     `gorm:"type:varchar(255)"`
	GatewayEnvironment        string     `gorm:"type:varchar(255)"`
	PaymenttransactionId      int        `gorm:"type:int"`
	SubscriptiontransactionId *int       `gorm:"default:null"`
	CreatedOn                 time.Time  `gorm:"type:datetime;not null"`
	CreatedBy                 int        `gorm:"type:int"`
	IsDeleted                 int        `gorm:"type:int"`
	DeletedOn                 *time.Time `gorm:"type:datetime;default:null"`
...
type TblLesson struct {
	Id         int        `gorm:"primaryKey;autoIncrement"`
	CourseId   int        `gorm:"type:int"`
	SectionId  int        `gorm:"type:int"`
	Title      string     `gorm:"type:varchar(255)"`
	Content    string     `gorm:"type:varchar(255)"`
	EmbedLink  string     `gorm:"type:varchar(255)"`
	FileName   string     `gorm:"type:varchar(255)"`
	FilePath   string     `gorm:"type:varchar(255)"`
	LessonType string     `gorm:"type:varchar(255)"`
	OrderIndex int        `gorm:"type:int"`
	TenantId   string     `gorm:"type:varchar(255)"`
	CreatedOn  *time.Time `gorm:"type:datetime;default:null"`
	CreatedBy  int        `gorm:"type:int"`
...
type TblLessonQuestions struct {
	Id         int        `gorm:"primaryKey;autoIncrement"`
	LessonId   int        `gorm:"type:int"`
...
type TblIntegration struct {
	...
	GatewayDesc  string     `gorm:"type:varchar(255)"`
	IsActive     int        `gorm:"type:int"`
	CreatedOn    time.Time  `gorm:"type:datetime;not null"`
	CreatedBy    int        `gorm:"type:int"`
	IsDeleted    int        `gorm:"type:int"`
...
type TblMenus struct {
	Id             int        `gorm:"primaryKey;autoIncrement"`
	Name           string     `gorm:"type:varchar(255)"`
	MenuTitle      string     `gorm:"type:varchar(255)"`
	Description    string     `gorm:"type:varchar(255)"`
	SlugName       string     `gorm:"type:varchar(255)"`
	TenantId       string     `gorm:"type:varchar(255)"`
	CreatedOn      time.Time  `gorm:"type:datetime;not null"`
	...
	CategoryIds    string     `gorm:"type:varchar(255)"`
	ImageName      string     `gorm:"type:varchar(255)"`
	ImagePath      string     `gorm:"type:varchar(255)"`
	OrderIndex     int        `gorm:"type:int"`
	SeparateWindow int        `gorm:"type:int"`
	MenuGroup      string     `gorm:"type:varchar(255)"`
}
...
type TblGoTemplateSettings struct {
	...
	TenantId        string `gorm:"type:varchar(255)"`
	WebsiteId       int    `gorm:"type:int"`
	HeaderThame     string `gorm:"type:varchar(255)"`
}
...
type TblListing struct {
	...
	EntryId      *int       `gorm:"type:int;default:null"`
	IsDeleted    int        `gorm:"type:int"`
	DeletedOn    *time.Time `gorm:"type:datetime;default:null"`
	DeletedBy    *int       `gorm:"type:int;default:null"`
	IsActive     int        `gorm:"type:int"`
	...
	MembershipId int        `gorm:"type:int"`
	Tag          string     `gorm:"type:varchar(255)"`
	TenantId     string     `gorm:"type:varchar(255)"`
	Featured     int        `gorm:"type:int"`
	CategoryId   int        `gorm:"type:int"`
	Status       int        `gorm:"type:int"`
}
...
type TblTemplatePages struct {
	...
	OgImage         string     `gorm:"type:varchar(255)"`
	WebsiteId       int        `gorm:"type:int"`
	PageType        string     `gorm:"type:varchar(255)"`
	CustomPagePath  string     `gorm:"type:varchar(255)"`
	ParentId        int        `gorm:"type:int"`
	OrderIndex      int        `gorm:"type:int"`
	CloneCount      int        `gorm:"type:int"`
}
...
type TblWidgets struct {
	Id              int       `gorm:"primaryKey;autoIncrement"`
	Title           string    `gorm:"type:varchar(255)"`
	LongTitle       string    `gorm:"type:varchar(255)"`
	Slug            string    `gorm:"type:varchar(255)"`
	Position        string    `gorm:"type:varchar(255)"`
	SortOrder       int       `gorm:"type:int"`
	WidgetType      string    `gorm:"type:varchar(255)"`
	TenantId        string    `gorm:"type:varchar(255)"`
	WebsiteId       int       `gorm:"type:int"`
	...
	WidgetLimit     int       `gorm:"type:int"`
	TemplateId      int       `gorm:"type:int"`
}

type TblWidgetProducts struct {
	Id        int       `gorm:"primaryKey;autoIncrement"`
	WidgetId  int       `gorm:"type:int"`
...
func MigrationTables() {
	...
	err := controllers.DB.AutoMigrate(
		...
		TblApps{},
		TblAiPrompt{},
		TblMstrMembershiplevel{},
		TblMstrMembergrouplevel{},
		TblMembershipOrder{},
		TblMembershipMembers{},
		TblMembershipCompanyInfo{},
		TblMembershipSubcriptions{},
		TblAiSettingsModule{},
		TblCountrie{},
		TblCourses{},
		TblSection{},
