...
type TblChannelEntries struct {
	...
	AccessType         string    `gorm:"type:character varying;DEFAULT:'every_one'"`
...
type TblChannelEntryFields struct {
	...
	FieldTypeId    int       `gorm:"type:integer;default:0"`
...
type TblLessonQuestions struct {
	Id         int       `gorm:"primaryKey;auto_increment;type:serial"`
	LessonId   int       `gorm:"type:integer"`
	Question   string    `gorm:"type:character varying"`
	TenantId   string    `gorm:"type:character varying"`
	Options    string    `gorm:"type:character varying"`
	Answer     string    `gorm:"type:character varying"`
	CreatedOn  time.Time `gorm:"type:timestamp without time zone;DEFAULT:NULL"`
	CreatedBy  int       `gorm:"type:integer"`
	ModifiedOn time.Time `gorm:"DEFAULT:NULL"`
	ModifiedBy int       `gorm:"type:integer;DEFAULT:NULL"`
...
type TblMenus struct {
	Id              int       `gorm:"primaryKey;auto_increment;type:serial"`
	Name            string    `gorm:"type:character varying"`
	MenuTitle       string    `gorm:"type:character varying"`
	Description     string    `gorm:"type:character varying"`
	SlugName        string    `gorm:"type:character varying"`
	TenantId        string    `gorm:"type:character varying"`
	CreatedOn       time.Time `gorm:"type:timestamp without time zone"`
	...
	CategoryIds     string    `gorm:"type:character varying"`
	ImageName       string    `gorm:"type:character varying"`
	ImagePath       string    `gorm:"type:character varying"`
	OrderIndex      int       `gorm:"type:integer"`
	MetaTitle       string    `gorm:"type:character varying"`
	...
	SeparateWindow  int       `gorm:"column:separate_window;type:integer"`
	MenuGroup       string    `gorm:"type:character varying"`
}
...
type TblGoTemplateSettings struct {
	...
	TenantId        string         `gorm:"type:character varying"`
	WebsiteId       int            `gorm:"type:integer"`
	TemplateType    datatypes.JSON `gorm:"type:jsonb"`
	SocialMediaLink datatypes.JSON `gorm:"type:jsonb"`
	HeaderThame     string         `gorm:"type:character varying"`
	TemplateID      string         `gorm:"type:character varying"`
}
...
type TblOrders struct {
	...
	PurchaseType string    `gorm:"type:character varying"`
	PurchaseDate time.Time `gorm:"type:timestamp without time zone"`
...
type TblPayment struct {
	...
	TenantId     string    `gorm:"type:character varying"`
	ListingId    int       `gorm:"type:integer"`
	PaymentRefID string    `gorm:"type:character varying"`
	PaidAmount   float64   `gorm:"type:decimal(10,2)"`
	PaidDate     time.Time `gorm:"type:timestamp without time zone"`
	PaymentType  int       `gorm:"type:integer"`
	PaymentMode  string    `gorm:"type:character varying"`
	Currency     string    `gorm:"type:character varying"`
	OrderID      string    `gorm:"type:character varying"`
}
...
type TblDownloadLogs struct {
	Id        int       `gorm:"primaryKey;autoIncrement;type:serial"`
	UserId    int       `gorm:"type:integer;not null"`
	ListingId int       `gorm:"type:integer;not null"`
	OrderId   int64     `gorm:"type:character varying"`
	TenantId  string    `gorm:"type:character varying;not null"`
	CreatedOn time.Time `gorm:"type:timestamp without time zone;autoCreateTime"`
	CreatedBy int       `gorm:"type:integer"`
}
...
func MigrationTables() {
	...
	controllers.DB.Exec("ALTER TABLE tbl_route_slugs ALTER COLUMN slug SET NOT NULL")
