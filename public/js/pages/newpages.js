...
function CKEDITORS() {
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("neweditor"), {
        toolbar: {
            items: ['heading', 'bold', 'italic', 'blockQuote', 'imageUpload', 'numberedList', 'bulletedList', 'todoList', 'horizontalLine', 'link', 'code', 'codeBlock'],
...
$(document).on('click', '.viewpage', function () {
    ...
    //    valueee= $('#readtimetag').val()

    //    console.log(valueee,"hhhhhhhh")
...
$(document).on('keyup', "#pagetitle", function () {
    ...
    if ($('.pageselected').hasClass('updpageview')) {
        ...
        if (id != 0 || newid != 0) {
            ...
            const pageindex1 = updPagesarr.findIndex(obj => {
            ...
            if (pageindex1 >= 0) {
                ...
                updPagesarr[pageindex1].Name = value
...
function ContentValidation() {
    ...
    for (let x of newpagesarr) {
        ...
        if (x.Name == '') {
            ...
            notify_content = `<div class="toast-msg dang-red" ><a id="cancel-notify" ><img src="/public/img/x-black.svg" alt="" class="rgt-img" /></a><img src="/public/img/danger-group-12.svg" alt="" class="left-img" /><span>Please Enter Page Title</span></div>`;
...
$(document).on('keyup', '#readtimetag', function () {
    ...
    // if (Readtime ==0){
    //     notify_content = `<div class="toast-msg dang-red" ><a id="cancel-notify" ><img src="/public/img/x-black.svg" alt="" class="rgt-img" /></a><img src="/public/img/danger-group-12.svg" alt="" class="left-img" /><span> Please Enter Reading Time Greater then one</span></div>`;
    //     $(notify_content).insertBefore(".header-rht");
    //     setTimeout(function () {
    //         $('.toast-msg').fadeOut('slow', function () {
    //             $(this).remove();
