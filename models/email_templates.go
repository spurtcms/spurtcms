...
type TblEmailTemplate struct {
	...
	TemplateSlug        string
	TenantId            string `gorm:"DEFAULT:1"`
}
...
func GetTemplateList(templates *[]TblEmailTemplate, limit, offset int, filter Filter, flag bool, tenantid string) ([]TblEmailTemplate, int64) {
...
func GetTempdetail(temp *TblEmailTemplate, id int, _ string) error {
...
func UpdateTemplate(template *TblEmailTemplate, _ string) error {
...
func TemplateStatus(id int, status int, userid int, _ string) error {
...
func GetTemplates(template *TblEmailTemplate, key string, tenantid string) error {
...
func CreateFileLog(logdata *TblImportfileLogs, tenantid string) error {
...
func GetFileLogs(logdata *[]TblImportfileLogs, tenantid string) ([]TblImportfileLogs, error) {
...
func GetTemplatesByModuleId(moduleid int, tenantid string) (templates *[]TblEmailTemplate, error bool) {
