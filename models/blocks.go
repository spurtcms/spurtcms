...
type TblMstrIntegration struct {
	...
	Credentials     datatypes.JSON `gorm:"type:jsonb" json:"credentials"`                  // e.g., AWS keys, bucket info, etc.
	IntegrationType string         `gorm:"type:character varying" json:"integration_type"` // e.g., "AWS", "GCP", "Azure"
