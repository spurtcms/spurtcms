...
func GetGeneralSettings(tenantid string) (gensetting TblGeneralSetting, err error) {
...
func UpdateGeneralSettings(gensetting TblGeneralSetting, tenantid string) error {
...
func UpdateLanuguageInGeneral(languageid int, tenantid string) error {
...
func GetTimeZones(tenantid string) (timzones []TblTimeZone, err error) {
...
func LastLoginActivity(userid, tenantid string) error {
